...
def visualize_circuit(circuit, formula):
...
def run_all():
    ...
    # 2. Convert circuit to formula
    formula = circuit_to_formula(circuit)
    # 3. Print the formula string
    print("Formula:", formula_to_string(formula))
    # 4. Visualize the circuit
    visualize_circuit(circuit, formula)
